...
<template>
  <div :class="props.isSelf ? 'flex justify-end' : 'flex justify-start'">
    <div
      v-if="props.show"
    ...
    <ScaleTransition>
      <div
        ...
        class="absolute z-[100] w-[200px] mt-2 rounded-sm bg-white shadow-lg border border-gray-100 focus:outline-none"
        role="menu"
