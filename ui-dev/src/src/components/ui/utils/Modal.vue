...
<template>
  ...
  >
    ...
    <SlideTransition animation="slide-down">
      <div
        v-show="props.open"
        class="fixed inset-0 z-10 h-full overflow-y-auto backdrop-brightness-50 bg-[#343A40]/30 "
      >
        <div
          ref="modal"
          @click="closeOnClick"
          id="close-modal"
          class="h-full flex items-center justify-center p-4  sm:items-center sm:p-0"
        >
          <!--content-->
