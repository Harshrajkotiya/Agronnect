  ...
  <div class="w-full h-full pt-6 flex flex-col items-center">
    ...
    <div class="mb-9 flex">
      ...
      <div class="mr-5 first-letter:flex flex-col justify-center items-center">
        <button
          class="p-3 mb-3 flex justify-center items-center rounded-full outline-none bg-gray-100 hover:bg-gray-200 focus:bg-gray-200 active:bg-gray-200 transition duration-200"
        >
          <UserPlusIcon
            class="w-[17px] h-[17px] text-black"
          />
        </button>
    ...
    <!--call actions-->
    <div
      class="relative w-full h-[50px] rounded-b flex justify-center bg-gray-50"
    >
