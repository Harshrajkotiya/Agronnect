...
<template>
  <button
    class="w-full p-5 flex outline-none hover:bg-indigo-100 focus:bg-indigo-100 active:bg-indigo-200 duration-200"
  >
    <!--profile image-->
    <div class="mr-4">
      <div
    ...
    <!--message date-->
    <div>
      <p class="font-light text-xs leading-4 tracking-[0.16px]">
